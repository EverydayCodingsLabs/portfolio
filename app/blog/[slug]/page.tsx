...
export async function generateMetadata({
	...
	// let ogImage = `https://everydaycodings.com/ogs/ogs-bg-blog-${post.slug}.png`;
	let ogImage = post.metadata.ogImage
		? post.metadata.ogImage
		: `https://cdn.everydaycodings.com/open-graph/business-card.png`;
	...
	return {
		...
		openGraph: {
			...
			type: "article",
			publishedTime,
			url: `https://everydaycodings.com/blog/${post.slug}`,
			images: [
				{
					url: ogImage,
				},
