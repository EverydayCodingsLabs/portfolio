...
export const metadata: Metadata = {
	...
	title: "Community",
	description:
		"Join the Ravix Studio community. Connect with Kumar Saksham and contribute to exciting projects.",
	alternates: {
		canonical: "/community",
	},
	openGraph: {
		title: "Community | Kumar Saksham",
		description:
			"Join the Ravix Studio community. Connect with Kumar Saksham and contribute to exciting projects.",
		url: "https://everydaycodings.com/community",
		...
		images: [
			{
				...
				width: 1200,
				height: 630,
				alt: "Join Kumar Saksham's Community",
			},
		],
		type: "website",
	},
				...
				<p>
					...
					<span className="not-prose">
						<Badge href="https://ravixstudio.com/">
							<Image
								src={"https://cdn.everydaycodings.com/logos/ravix-dark.png"}
								alt="Ravix Studio"
								height={16}
								width={16}
								className={"pr-1"}
